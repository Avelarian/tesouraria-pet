...
router.get('/cashier/historical', checkAuth, (req, res, next) => {
    UserHistorical.find({ $or: [ {from_place: 'Caixinha'}, {to_place: 'Caixinha'} ]})
        .exec()
        .then(doc => {
            console.log(doc);
            if (doc) {
...
router.get('/safe/historical', checkAuth, (req, res, next) => {
    UserHistorical.find({ $or: [ {from_place: 'Cofre'}, {to_place: 'Cofre'} ]})
        .exec()
        .then(doc => {
            console.log(doc);
            if (doc) {
...
router.get('/bankAccount/historical', checkAuth, (req, res, next) => {
    UserHistorical.find({ $or: [ {from_place: 'Conta Bancaria'}, {to_place: 'Conta Bancaria'} ]})
        .exec()
        .then(doc => {
            console.log(doc);
            if (doc) {
